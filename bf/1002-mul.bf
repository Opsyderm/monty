 ++++[>++++[>+++<-]<-]   writing 48 / 0x30 / '0' in cell(2)
    ...
    [<-<->>-]               reducing cell(0) and cell(1) by 48 / 0x30 / '0'
    <<                      go to cell(0)
    [                       mulitplication loop
        >                   go to cell(1)
    ...
    >[-]<                   set cell(1) to 0 so it can be used as counter (we are in cell 0 here)
    ++++[>++++[>+++<-]<-]   adding 48 / 0x30 / '0' to cell(2) cell 2 has the outcome
